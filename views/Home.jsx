...
const Home = ({ lang }) => {
    ...
    const cvLink = lang === 'fr' ? process.env.NEXT_PUBLIC_CV_FR_LINK : process.env.NEXT_PUBLIC_CV_EN_LINK;
    ...
    return (
        <S.Container>
            <Head>
                ...
                <link href={process.env.NEXT_PUBLIC_DOMAIN} rel="alternate" hrefLang='fr' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en'} rel="alternate" hrefLang='en' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en'} rel="alternate" hrefLang='x-default' />
        ...
        & > h1 {
            ...
            & .svg {
                ...
                &::after {
                    ...
                    top: 20%;
                    z-index: -1;
                    transform: ${(props) => (props.lang === 'fr' ? 'scale(1.5, 1)' : 'scale(1.1, 1)')};
                    transition: 0.3s;
                }
            }
        }
