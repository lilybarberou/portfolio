    ...
    return (
        <S.Container>
            <Head>
                ...
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/realisations'} rel="alternate" hrefLang='fr' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/works'} rel="alternate" hrefLang='en' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/works'} rel="alternate" hrefLang='x-default' />
            ...
            <S.Title>
                <h1 className={`${lang === 'fr' ? '' : 'en'}`}>{translations.works}</h1>
            </S.Title>
            <Separation />
