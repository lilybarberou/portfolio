...
const About = ({ lang }) => {
    ...
    return (
        <S.Container id='container'>
            <Head>
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/a-propos-de-lily'} rel="alternate" hrefLang='fr' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/about-me'} rel="alternate" hrefLang='en' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/about-me'} rel="alternate" hrefLang='x-default' />
            ...
            > span {
                ...
                .svg {
                    ...
                    ::after {
                        ...
                        top: 12%;
                        z-index: -1;
                        transform: ${(props) => (props.lang === 'fr' ? 'scale(1.1, 1.2)' : 'scale(2.4, 1.2)')};
                        transition: 0.3s;
                    }
                }
            }
