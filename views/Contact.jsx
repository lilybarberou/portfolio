    ...
    return (
        <S.Container>
            <Head>
                ...
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/contact'} rel="alternate" hrefLang='fr' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/contact'} rel="alternate" hrefLang='en' />
                <link href={process.env.NEXT_PUBLIC_DOMAIN + '/en/contact'} rel="alternate" hrefLang='x-default' />
