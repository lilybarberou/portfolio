...
const S = {
  GourmetContainer: styled.section`
    display: flex;
  ...
  DrawingsContainer: styled.section`
    position: relative;
    display: flex;
    flex-direction: column;
    height: 955px;
