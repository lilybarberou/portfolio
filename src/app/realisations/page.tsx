...
export const metadata: Metadata = {
  ...
  description: 'Découvrez les réalisations web de Lily Barberou, de son autoportrait au chat uspeak, plateforme de vente Charlemagne, API QuoteWars, etc...',
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SCREENSHOT_LINK}/lilybarberou.fr-realisations.png`,
        width: 800,
        height: 600,
