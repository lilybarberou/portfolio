...
export const metadata: Metadata = {
  ...
  description:
    "Apprenez-en plus sur Lily Barberou, que ce soit dans sa vie de développeuse web, ou encore ses passions, tout en un mot.",
  openGraph: {
    ...
    images: [
      {
        url: `${env.NEXT_PUBLIC_SCREENSHOT_LINK}/lilybarberou.fr-a-propos-de-lily.png`,
        width: 800,
        height: 600,
